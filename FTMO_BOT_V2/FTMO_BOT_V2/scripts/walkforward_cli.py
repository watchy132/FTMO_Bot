...
def main():
    ...
    p.add_argument(
        "--close-col", default=None, help="Name of close column in CSV (default: try Close/close/last column)"
    )
    ...
    p.add_argument(
        "--position-sizing", choices=["fixed", "atr"], default="fixed", help="Position sizing method: fixed or atr"
    )
    p.add_argument(
        "--atr-method",
        choices=["sma", "wilder"],
