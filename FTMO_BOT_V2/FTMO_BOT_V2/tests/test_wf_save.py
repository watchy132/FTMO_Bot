from src.bot.optimizer import walk_forward_evaluate, save_walkforward_csv, save_walkforward_json, save_top_from_walkforward
import os
...
def test_walkforward_saves(tmp_path):
    ...
    aggregated = walk_forward_evaluate(prices, short_windows=[3,5], long_windows=[20,30], train_size=100, test_size=30)
