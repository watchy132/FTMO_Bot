...
PROFILES = {t: {"risk_per_trade_pct":0.25, "max_daily_loss_pct":5, "max_total_loss_pct":10} for t in TIERS}
...
def main():
    ...
    payload = {
        ...
        "account": {
            "login": ai.login, "name": ai.name, "server": ai.server,
            "currency": ai.currency, "leverage": ai.leverage,
            "balance": bal, "equity": float(ai.equity)
        },
